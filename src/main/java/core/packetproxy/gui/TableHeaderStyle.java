...
/**
 * Utility class for applying consistent header styles to JTable.
 * Preserves sort icons on the right edge while maintaining left-aligned text.
 */
public class TableHeaderStyle {

    /**
     * Applies a consistent header style to all columns of a JTable.
     * This method preserves sort icons and positions them on the right edge.
     *
     * @param table the JTable to style
     * @param columnCount the number of columns to apply styling to
     */
        ...
        TableCellRenderer headerRenderer = new TableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
                ...
                if (c instanceof JLabel) {
                    ...
                    // Create a panel with BorderLayout to position text on left and icon on right edge
